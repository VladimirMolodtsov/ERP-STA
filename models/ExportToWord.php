...
// Based on https://github.com/Korchy/html_to_doc
//------------------------------------------------------------------------------------------------------------------------------------------------------
...
class ExportToWord extends Model
{
	...
	private static $imgDir = '/img/';				          	// path to the images directory in absolute format
  ...
  public function rules()
	...
	public static function htmlToDoc($srcHtml, $srcCss, $filePath = NULL, $filePathEncoding = 'UTF-8', $pageOrientation = 0) {
		// Converting from html to *.doc into the file $filePath
		$entities = static::htmlEntities($srcHtml);	// Get image data
		$body = '';
		$body .= static::headDoc($srcCss,$pageOrientation);
	...
	private static function headDoc($css, $pageOrientation = 0) {
		// *.doc header

		$pageParam =[
		0 => '{size:595.3pt 841.9pt;
				margin:1.5cm 1.5cm 1.5cm 1.5cm;
				mso-header-margin:35.4pt;
				mso-footer-margin:35.4pt;
				mso-paper-source:0;}',

		1 => '{size:841.9pt 595.3pt;
				margin:1.5cm 1.5cm 1.5cm 1.5cm;
				mso-header-margin:35.4pt;
				mso-footer-margin:35.4pt;
				mso-paper-source:0;}',
