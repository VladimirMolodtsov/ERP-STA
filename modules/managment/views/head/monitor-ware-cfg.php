...
$this->title = 'Использование отчета по закупкам';
        ...
        'columns' => [       
            ...
            [
                ...
                'value' => function ($model, $key, $index, $column) use ($rowRef) {
                 ...
                 $out = "";
                 $id = '5minus'.$model['id'];
                 $action="setDiv(".$rowRef.",".$model['id'].", -1, 5 )";
               ...
               $out .= "&nbsp;";
                 $id = '5zero'.$model['id'];
                 $action="setDiv(".$rowRef.",".$model['id'].",0, 5)";
        ...
        'columns' => [       
            ...
            [
                ...
                'value' => function ($model, $key, $index, $column) use ($rowRef) {
                 ...
                 $out = "";
                 $id = '6minus'.$model['id'];
                 $action="setDiv(".$rowRef.",".$model['id'].", -1, 6 )";
                 if ( $val == -1 ) $style = "color:White;background-color:Crimson;";
                              else $style = "color:Blue ;background-color:White;";
                 $out .= \yii\helpers\Html::tag( 'span', ' -1 ', 
                   [
               ...
               $out .= "&nbsp;";
                 $id = '6zero'.$model['id'];
                 $action="setDiv(".$rowRef.",".$model['id'].",0, 6)";
                 if ( $val == 0 )  $style = "color:Black;background-color:LightGray;";
                              else $style = "color:Blue ;background-color:White;";
                 $out .= \yii\helpers\Html::tag( 'span', ' 0 ', 
                   [
