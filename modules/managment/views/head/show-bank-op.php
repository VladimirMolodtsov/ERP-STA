...
{
  openWin('/managment/head/sync-bank-operation&st='+syncTime,'syncWin');  
}
</script>
...
<div class ='row'>
   ...
   <div class ='col-md-2'>   
     <a href='index.php?r=managment/head/show-bank-op&noframe=1'>Сбросить фильтры</a>
   </div>
        ...
        'columns' => [       
            ...
            [
                ...
                'value' => function ($model, $key, $index, $column) {
                  return number_format($model['recordSum'] ,2,'.','&nbsp;');
                }
