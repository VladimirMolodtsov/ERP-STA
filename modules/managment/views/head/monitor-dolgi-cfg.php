...
$this->title = 'Использование отчета по сверке долга';
...
width:20px;
  ...
  <h4>Учитываемые организации собственника</h3>
<?php                    
        ...
        'columns' => [       
            ...
            [
                ...
                'value' => function ($model, $key, $index, $column) use ($rowRef) {
                 ...
                 $out = "";
                 $id = '3minus'.$model['id'];
                 $action="setDiv(".$rowRef.",".$model['id'].", -1, 3 )";
               ...
               $out .= "&nbsp;";
                 $id = '3zero'.$model['id'];
                 $action="setDiv(".$rowRef.",".$model['id'].",0, 3)";
...
?>
  ...
  <h4>Учитывать сверку с контрагентом</h3>
<?php                    
echo  GridView::widget(
    [
        ...
        'columns' => [       
            ...
            [
                ...
                'value' => function ($model, $key, $index, $column) use ($rowRef) {
                 ...
                 $out = "";
                 $id = '4minus'.$model['id'];
                 $action="setDiv(".$rowRef.",".$model['id'].", -1, 4 )";
                 if ( $val == -1 ) $style = "color:White;background-color:Crimson;";
                              else $style = "color:Blue ;background-color:White;";
                 $out .= \yii\helpers\Html::tag( 'span', ' -1 ', 
                   [
               ...
               $out .= "&nbsp;";
                 $id = '4zero'.$model['id'];
                 $action="setDiv(".$rowRef.",".$model['id'].",0, 4)";
                 if ( $val == 0 )  $style = "color:Black;background-color:LightGray;";
                              else $style = "color:Blue ;background-color:White;";
                 $out .= \yii\helpers\Html::tag( 'span', ' 0 ', 
                   [
