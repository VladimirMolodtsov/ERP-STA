...
//$execute['reestr'][$shift] = $list[$i]['id']; // сделано в это период                          
 ...
 public function prepareDateList()
 {
   ...
   $lastDt =Yii::$app->db->createCommand('SELECT max(checkDate) FROM {{%buh_stat_header}} 
   WHERE isSynced=1 and checkDate <= :checkdate  and isMonth =1',
...
//echo "$col\n";          
       ...
       $checkdate = date("Y-m-d", $this->timeList[$col]); 
       $header = TblBuhStatHeader::findOne(['checkDate'  => $checkdate]);
 ...
 public function fillAutoBuhStatData($dateTime)
{
  $checkdate = date("Y-m-d", $dateTime);
     ...
     //счета
     $record= TblBuhStatistics::findOne(['checkdate'  => $checkdate,'row' => 1]);
     ...
     //Отгрузки
     $record= TblBuhStatistics::findOne(['checkdate'  => $checkdate,'row' => 2]);
     if (empty($record)) $record = new  TblBuhStatistics();     
     $record->checkdate = $checkdate;
     $record->row = 2;
     $record->headerRef= $header->id; 
     ...
     $headerRef = Yii::$app->db->createCommand( 'SELECT  MAX(id) FROM {{%profit_header}} WHERE DATE(onDate) = :checkdate',
             [ ':checkdate' => $checkdate  ] )->queryScalar();            
     $record= TblBuhStatistics::findOne(['checkdate'  => $checkdate,'row' => 3]);
     if (empty($record)) $record = new  TblBuhStatistics();     
     $record->checkdate = $checkdate;
     $record->row = 3;
     $record->headerRef= $header->id; 
     ...
     //Приход денег    
     $record= TblBuhStatistics::findOne(['checkdate'  => $checkdate,'row' => 4]);
     if (empty($record)) $record = new  TblBuhStatistics();     
     $record->checkdate = $checkdate;
     $record->row = 4;
     $record->headerRef= $header->id; 
     ...
     //Траты    
     $record= TblBuhStatistics::findOne(['checkdate'  => $checkdate,'row' => 5]);
     if (empty($record)) $record = new  TblBuhStatistics();     
     $record->checkdate = $checkdate;
     $record->row = 5;
     $record->headerRef= $header->id; 
     ...
     $record= TblBuhStatistics::findOne(['checkdate'  => $checkdate,'row' => 6]);
     if (empty($record)) $record = new  TblBuhStatistics();     
     $record->checkdate = $checkdate;
     $record->row = 6;
     $record->headerRef= $header->id; 
    ...
    $headerRef = Yii::$app->db->createCommand( 'SELECT  MAX(id) FROM {{%control_purch_header}} WHERE DATE(onDate) = :checkdate',
     ...
     $record= TblBuhStatistics::findOne(['checkdate'  => $checkdate,'row' => 8]);
     if (empty($record)) $record = new  TblBuhStatistics();     
     $record->checkdate = $checkdate;
     $record->row = 8;
     $record->headerRef= $header->id; 
    ...
    $headerRef = Yii::$app->db->createCommand( 'SELECT  MAX(id) FROM {{%ware_header}} WHERE DATE(onDate) = :checkdate',
     ...
     $record= TblBuhStatistics::findOne(['checkdate'  => $checkdate,'row' => 9]);
     if (empty($record)) $record = new  TblBuhStatistics();     
     $record->checkdate = $checkdate;
     $record->row = 9;
     $record->headerRef= $header->id; 
     ...
     $record= TblBuhStatistics::findOne(['checkdate'  => $checkdate,'row' => 18]);
     if (empty($record)) $record = new  TblBuhStatistics();     
     $record->checkdate = $checkdate;
     $record->row = 18;
     $record->headerRef= $header->id; 
    ...
    $record= TblBuhStatistics::findOne(['checkdate'  => $checkdate,'row' => 7]);
     if (empty($record)) $record = new  TblBuhStatistics();     
     $record->checkdate = $checkdate;
     $record->row = 7;
     $record->headerRef= $header->id; 
    ...
    $record= TblBuhStatistics::findOne(['checkdate'  => $checkdate,'row' => 10]);
     if (empty($record)) $record = new  TblBuhStatistics();     
     $record->checkdate = $checkdate;
     $record->row = 10;
     $record->headerRef= $header->id; 
    ...
    $record= TblBuhStatistics::findOne(['checkdate'  => $checkdate,'row' => 11]);
     if (empty($record)) $record = new  TblBuhStatistics();     
     $record->checkdate = $checkdate;
     $record->row = 11;
     $record->headerRef= $header->id; 
    ...
    $record= TblBuhStatistics::findOne(['checkdate'  => $checkdate,'row' => 12]);
     if (empty($record)) $record = new  TblBuhStatistics();     
     $record->checkdate = $checkdate;
     $record->row = 12;
     $record->headerRef= $header->id; 
    ...
    $record= TblBuhStatistics::findOne(['checkdate'  => $checkdate,'row' => 13]);
     if (empty($record)) $record = new  TblBuhStatistics();     
     $record->checkdate = $checkdate;
     $record->row = 13;
     $record->headerRef= $header->id; 
    ...
    $record= TblBuhStatistics::findOne(['checkdate'  => $checkdate,'row' => 14]);
     if (empty($record)) $record = new  TblBuhStatistics();     
     $record->checkdate = $checkdate;
     $record->row = 14;
     $record->headerRef= $header->id; 
    ...
    $record= TblBuhStatistics::findOne(['checkdate'  => $checkdate,'row' => 15]);
     if (empty($record)) $record = new  TblBuhStatistics();     
     $record->checkdate = $checkdate;
     $record->row = 15;
     $record->headerRef= $header->id; 
    ...
    $record= TblBuhStatistics::findOne(['checkdate'  => $checkdate,'row' => 16]);
     if (empty($record)) $record = new  TblBuhStatistics();     
     $record->checkdate = $checkdate;
     $record->row = 16;
     $record->headerRef= $header->id; 
    ...
    $record= TblBuhStatistics::findOne(['checkdate'  => $checkdate,'row' => 17]);
     if (empty($record)) $record = new  TblBuhStatistics();     
     $record->checkdate = $checkdate;
     $record->row = 17;
     $record->headerRef= $header->id; 
    ...
    $record= TblBuhStatistics::findOne(['checkdate'  => $checkdate,'row' => 19]);
     if (empty($record)) $record = new  TblBuhStatistics();     
     $record->checkdate = $checkdate;
     $record->row = 19;
     $record->headerRef= $header->id; 
