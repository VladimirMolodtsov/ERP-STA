...
$errorList = $model->getControlList($month, $year);
...
{
 window.parent.setControlFilter (d,month,year);   
...
document.location.href='index.php?r=/bank/operator/doc-control-calendar&noframe=1&fromDate='+fromDate+'&toDate='+toDate+'&year='+y+'&month='+m; 
...
<input type='hidden' name='r' value='bank/operator/doc-control-calendar'>
<input type='hidden' name='noframe' value='1'>
<table border='0' width='100%' style='padding:5px' >
<tr>
<td style='width:150px;padding:2px'>
<select style='width:150px;padding:2px' name='month' id='month' class="form-control" onchange='chngMonth();'>
<?php
for ($i=1; $i<=12; $i++)
{
    $p = "<option value='".$i."'";
...
<td style='width:100px;padding:5px'><input name='year' id='year' style='width:100px;padding:2px' class="form-control" onchange='chngMonth();' value='<?= $year ?>'> </td>
