...
<tr>
    ...
    <td><a class='action_ref' href="index.php?r=/bank/operator/sync-bank-operation&sd=<?= $st ?>&ed=<?= $et ?>" target='_blank'><span class="glyphicon  glyphicon-refresh" aria-hidden='true'></span></a>&nbsp;
     <?php     
