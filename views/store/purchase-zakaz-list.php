...
$this->title = 'Перечень запросов на закупку товара';
?>
        ...
        'columns' => [
            ...
            [
                ...
                'value' => function ($model, $key, $index, $column) {    
                  return "<nobr><a href='#' onclick='openWin(\"\store/purchase-zakaz&noframe=1&id=".$model['id']."\",\"storeWin\");'>".$model['id']." от ".date('d.m.Y', strtotime($model['zakazDate']))."</a></nobr>";     
                }
            ],		
