...
<thead>
    ...
    <th width='100px'>Адрес отгрузки</th>
    <th width='100px'>Адрес доставки</th>    
    <th width='50px'>Что делать</th>
    <th width='50px'>Номер УПД</th>
    
    <th width='150px'>Товар</th>    
    <th width='75px'>Вид<br>Категория</th>   
    <th width='75px'>К-во мест</th>   
...
<tr>
    ...
    <td ><?= $deliversListData[$i]['requestCategory'] ?></td>    
    <td ><?php if(!empty($deliversListData[$i]['requestPlaces'])) echo $deliversListData[$i]['requestPlaces'] ?></td>    
...
<tr>
    <td colspan='10' align='right'><b>Итого вес:</b></td>    
