        ...
        'columns' => [
            ...
            [
                ...
                'value' => function ($model, $key, $index, $column) {    
                  return "<nobr><a href='#' onclick='openWin(\"\store/purchase&noframe=1&id=".$model['id']."\",\"storeWin\");'>".$model['id']." от ".date('d.m.Y', strtotime($model['dateCreation']))."</a></nobr>";     
                }
            ],		
		        ...
		        if (count($statusList) == 0) return "Не запрошен";
                    ...
                    switch ($statusList[0]['etap'])
                    {
                        ...
                        case 1: 
                            ...
                            break;
                        case 2: 
                            $retVal ="На согласовании ".$statusList[0]['execDate'];                            
                            break;
                        case 3: 
                            $retVal ="<div class='gridcell' style='background-color:PaleGreen;' >Согласован ".$statusList[0]['execDate'] ."</div>";                        
                            break;
