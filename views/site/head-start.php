...
<table border='0' width='1140px'>
    ...
    <tr>
        ...
        <td>
        <input class="btn btn-primary"  style="width:200px" type="button" value="Настройка " onclick="javascript:openWin('site/config','childWin');"/>
        </td>
    </tr>    
    ...
    <tr>
        ...
        <td>
        <input class="btn btn-primary"  style="width:200px" type="button" value="Контроль бухгалтерии" onclick="document.location.href='index.php?r=fin/buh-schet';"/>
        </td>

        <td>
        <input class="btn btn-primary"  style="width:200px" type="button" value="Фин. контроль" onclick="document.location.href='index.php?r=/managment/fin/fin-control';"/>
        </td>
        
        <td>
        <input class="btn btn-primary"  style="width:200px" type="button" value="Диспетчер" onclick="document.location.href='index.php?r=tasks/dispetcher';"/>
        </td>

        <td>
        <input class="btn btn-primary"  style="width:200px" type="button" value="Коммерческий директор" onclick="javascript:window.location='index.php?r=head/market-head'"/>    
        </td>        
    ...
    <tr>
        <td>
        <input class="btn btn-primary"  style="width:200px" type="button" value="Аврора " onclick="document.location.href='index.php?r=/bank/aurora/extract-list';"/>
        </td>

        <td>
        <input class="btn btn-primary"  style="width:200px" type="button" value="Монитор " onclick="document.location.href='index.php?r=managment/head/head-monitor';"/>
        </td>

        <td>
        <input class="btn btn-primary"  style="width:200px" type="button" value="Бух. статистика " onclick="document.location.href='index.php?r=bank/buh/buh-month-statistics';"/>
        </td>
        
        <td>
        <input class="btn btn-primary"  style="width:200px" type="button" value="Движение по банку" onclick="document.location.href='index.php?r=bank/buh/stat-bank';"/>        
        </td>
 ...
 <tr>
   <td>
    ...
    <table border='0' width='600px'> 
        ...
        href='#' onclick="openFullWin('site/head-leads-list','childwin');"><div class='leaf-txt' style='font-size:12px;' >Лиды, рассмотреть: </div>
        <div class='leaf-val' style='font-size:20px;' ><?= $leafValue['leadHeadCount'] ?></div> </a> </td>        
        
        <td> <a  class='btn btn-primary leaf' style='background:Brown; color:White; height:60px;' 
        href='#' onclick="openWin('site/new-lead','newLeadWin');"><div class='leaf-txt' style='font-size:12px;' >Новый лид </div>
        <div class='leaf-val' style='font-size:20px;' ></div> </a> 
        </td>
        ...
        <td> <a  class='btn btn-primary leaf' style='background:MintCream  ; color:Blue;'                  href='index.php?r=site/head-start&detail=1#detail_list'>
        ...
        <td> <a  class='btn btn-primary leaf' style='background:MintCream  ; color:Blue;'         href='index.php?r=site/head-start&detail=5#detail_list'>
        ...
        <td> <a  class='btn btn-primary leaf' style='background:MintCream  ; color:Gray;'                  href='index.php?r=site/head-start&detail=9#detail_list'><div class='leaf-txt'>В работе: </div><div class='leaf-val'><?= $model->getCurrentEvents(2) ?></div> </a></td>

    <?php if ($leafValue[9]>0){$bgColor="Crimson"; $color="White";} else {$bgColor="MintCream";$color="ForestGreen";}  ?>        
        <td> <a  class='btn btn-primary leaf' style='background:<?= $bgColor ?>    ; color:<?= $color ?>;' href='index.php?r=site/head-start&detail=13#detail_list'><div class='leaf-txt'>По суммам: </div><div class='leaf-val'><?= $leafValue[9] ?></div> </a></td>
        </tr> 

        <tr>    
        <td> <a  class='btn btn-primary leaf' style='background:WhiteSmoke ; color:Blue;'         href='index.php?r=site/head-start&detail=2#detail_list'>
        ...
        <td> <a  class='btn btn-primary leaf' style='background:WhiteSmoke ; color:Blue;'         href='index.php?r=site/head-start&detail=6#detail_list'>
        ...
        <td> <a  class='btn btn-primary leaf' style='background:WhiteSmoke;  color:<?= $color ?>;'         href='index.php?r=site/head-start&detail=10#detail_list'><div class='leaf-txt'>Брошено: </div><div class='leaf-val'><?= $val;?></div> </a></td>        

    <?php if ($leafValue[10]>0){$bgColor="Crimson"; $color="White";} else {$bgColor="MintCream";$color="ForestGreen";}  ?>                
        <td> <a  class='btn btn-primary leaf' style='background:<?= $bgColor ?>; color:<?= $color ?>'      href='index.php?r=site/head-start&detail=14#detail_list'><div class='leaf-txt'>По документам: </div><div class='leaf-val'><?= $leafValue[10] ?></div> </a></td>        
        </tr> 

        <tr>
        <td><a  class='btn btn-primary leaf' style='background:MintCream ;  color:Blue;'          href='index.php?r=site/head-start&detail=3#detail_list'>
        ...
        <td><a  class='btn btn-primary leaf' style='background:MintCream ; color:Blue;'           href='index.php?r=site/head-start&detail=7#detail_list'>
        <div class='leaf-txt'>В Оплате: </div>
        <div class='leaf-val'><?= $leafValue['cashProc'] ?></div>
        <div class='leaf-sub' ><?= $leafValue['cashProcSumm'] ?></div>
        </a></td>        

        <td><a  class='btn btn-primary leaf' style='background:MintCream ; color:Green;'                   href='index.php?r=site/head-start&detail=11#detail_list'><div class='leaf-txt'>Новых в работе: </div><div class='leaf-val'><?= $model->getCurrentEvents(3) ?></div> </a></td>                
       ...
       <td><a  class='btn btn-primary leaf' style='background:MintCream ; color:<?= $color ?>;'           href='index.php?r=store/head-sclad&detail=12'>
        <div class='leaf-txt'>Склад: </div>
        <div class='leaf-val'><?= number_format($leafValue['storeStatus'],1,'.','&nbsp;') ?>%</div>
        ...
        <tr>    
        <td><a  class='btn btn-primary leaf' style='background:WhiteSmoke ; color:Blue;'          href='index.php?r=site/head-start&detail=4#detail_list'> 
    ...
    <?php if ($leafValue['finitProc']>0){$color="Blue";} else {$color="ForestGreen";}  ?>        
        <td><a  class='btn btn-primary leaf' style='background:WhiteSmoke  ; color:<?= $color ?>;'         href='index.php?r=site/head-start&detail=8#detail_list'>
        ...
        <td><a  class='btn btn-primary leaf' style='background:WhiteSmoke ; color:Gray;'               href='index.php?r=site/head-start&detail=12#detail_list'>  <div class='leaf-txt'>Доступно новых: </div><div class='leaf-val'><?= $cold_model->noContactCount(); ?></div> </a></td>                

        <td>
            <a  class='btn btn-primary leaf' style='background:WhiteSmoke ; color:Blue;'  
            href='index.php?r=store/purchase-table&mode=37'>  <div class='leaf-txt'>Закупки: </div>
            <div class='leaf-val'><?= $leafValue['requestInSogl']?> | <?= $leafValue['purchaseInSogl']?></div> 
            <div class='leaf-sub' ></div>
            </a>       
        </td>                 
        </tr>         
...
<tr>
<td><a  class='btn btn-primary leaf' style='background:WhiteSmoke ; color:Blue;' href='#' onclick='openFullWin("head/sdelka-list&noframe=1","sdelkaWin");' >
...
<td><a  class='btn btn-primary leaf' style='background:Blue ; color:White;'
                   href='index.php?r=site/head-start&detail=15#detail_list'><div class='leaf-txt' >Реестр клиентов: </div><div class='leaf-val' ><?= $leafValue[11] ?></div> </a></td>                
</tr>
...
<br>
<div class='row'>
  <div class='col-md-6'><a href="#" onclick="openEditWin('index.php?r=site/head-start&<?= Yii::$app->request->queryString  ?>&format=csv');"> Выгрузить</a> </div>
  <div class='col-md-6'>
  <?php  
    if ($model->detail == 15 )  echo "<a href='#' onclick=\"openEditWin('index.php?r=site/head-start&".Yii::$app->request->queryString."&format=phone');\"> Список телефонов</a> "; 
  ?>
  </div>
</div>
