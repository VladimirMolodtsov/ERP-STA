...
$this->title = 'Сводная статистика контактов за год';
...
<a class="btn btn-primary"  href='index.php?r=site/stat-year-oplata'>По оплатам</a>&nbsp;&nbsp;
<a class="btn btn-primary"  href='index.php?r=site/stat-year-goods'>По товару</a>&nbsp;&nbsp;
<a class="btn btn-primary" style='background: Silver;' href='index.php?r=site/stat-year-contacts'>По контактам</a>&nbsp;&nbsp;
<a href="#" onclick="openEditWin('index.php?r=site/stat-year-contacts&<?= Yii::$app->request->queryString  ?>&format=csv');"> Выгрузить</a> 
<div>
<?php
  $monthTitles = array(
	"1" => "январь",
