...
$this->title = 'Сканирование данных из 1C - Отгрузка';
?>
<style>
.button {
...
if ($mode == 1) {echo "data/import-postavka";}
if ($mode == 2) {echo "data/import-postavka";}
if ($mode == 3) {echo "data/load-supply-activity";}
?>">
