...
$this->title = 'Счета выставленные клиентам (по данным 1С).';
...
<a href="#" onclick="openEditWin('index.php?r=fin/client-schet-src&noframe=1&frame=0&<?= Yii::$app->request->queryString  ?>&format=csv');"> Выгрузить</a> 
<br> <?= $model->getCfgValue(106) ?>&nbsp;&nbsp; <a href='index.php?r=data/sync-schet' target='_blank'><span class="glyphicon  glyphicon-refresh" aria-hidden='true'></span></a>
</div>
<br>
<div>
<form name='fltForm' method='get' action='index.php'>
<input type='hidden' name='r' value='fin/client-schet-src'>
            ...
            [
     	    ...
     	    [
                ...
                'value' => function ($model, $key, $index, $column) {                
                    return number_format($model['wareSum'],2,'.','');
                }                                
     	    ...
     	    [
                ...
                'format' => 'raw',
                'value' => function ($model, $key, $index, $column) {                
                    return number_format($model['wareSum']/$model['wareCount'],2,'.','');
                }                                
