...
$this->title = 'Прибыль и рентабельность';
...
<div class ='row'>
  ...
  <div class='col-md-1' style='text-align:right;'><a href='index.php?r=data/sync-profit&parentForm=self&syncTime=<?= $now ?>'><span class='glyphicon glyphicon-refresh'></span></a></div>  
</div>
