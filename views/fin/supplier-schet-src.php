...
$this->title = 'Счета от поставщиков.';
...
<a href="#" onclick="openEditWin('index.php?r=fin/supplier-schet-src&<?= Yii::$app->request->queryString  ?>&format=csv');"> Выгрузить</a> 
<br> <?= $model->getCfgValue(117) ?>&nbsp;&nbsp; <a href='index.php?r=data/sync-supplier-schets&reload=1' target='_blank'><span class="glyphicon  glyphicon-refresh" aria-hidden='true'></span></a>
</div>
<br>
<?php if (empty($model->refSuppSchet)){?>
<div>
<form name='fltForm' method='get' action='index.php'>
<input type='hidden' name='r' value='fin/supplier-schet-src'>
            ...
            [
     	    ...
     	    [
                ...
                'value' => function ($model, $key, $index, $column) {                
                    return "<nobr>".mb_substr($model['goodTitle'],0,48 ,'UTF-8')."</nobr>";
                }                
