...
$editTitleList = $model->getEditTitle();
        ...
        /*    [
            ...
            [
                ...
                'value' => function ($model, $key, $index, $column) {
					...
					return  "<div  class='gridcell' style='width:65px;' onclick=\"javascript:openSchetList('".$model['id']."');\">&nbsp;".$val."</div>"; 
                },
     	    ...
     	    [
                ...
                'value' => function ($model, $key, $index, $column) {
					...
					return  "<div  class='gridcell'  style='width:60px;' onclick=\"javascript:openSchetList('".$model['id']."');\">&nbsp;".$val."</div>"; 
                },
            ...
            [
     	    ...
     	    [
                ...
                if (!empty($model['schNum'])) $ret = "<div style='width:75px; text-align:right;'>".number_format($model['summRequest'],2,'.','&nbsp;')."</div>";
                else {
                    
                $ret ="<div id='viewBox_".$id."' class='gridcell'  style='width:75px; text-align:right;' onclick=\"javascript:showEditBox('".$id."');\">&nbsp;".number_format($model['summRequest'],2,'.','&nbsp;')."</div>"; 
                $ret.="<div id='editBox_".$id."' class='editcell' style='width:100px;' ><nobr>";
     	    ...
     	    [
                ...
                $oplSumm = Yii::$app->db->createCommand("Select Sum(lnkOplate) from  {{%reestr_lnk}} 
                 ...
                 color:".$color.";*/
                $ret= "<div  class='gridcell' style='width:100px;   text-align:right;' onclick=\"javascript:openOplateList('".$model['id']."');\" >".number_format($oplSumm,2,'.','&nbsp;')."&nbsp;&nbsp;&nbsp;<span class='glyphicon glyphicon-plus' aria-hidden='true'></span></div>";
...
//                $ret= "<div style='color:Brown;'>".number_format(($model['summRequest']-$oplSumm),2,'.','&nbsp;')."</div>";
     	    ...
     	    [
                ...
                $ret ="<div id='viewBox_".$id."' style='width:75px; text-align:right;'  class='gridcell' onclick=\"javascript:showEditBox('".$id."');\">&nbsp;". number_format($model['summOplate'],2,'.','&nbsp;')."</div>"; 
                $ret.="<div id='editBox_".$id."' class='editcell' style='width:100px;'><nobr>";
            ...
            [
                ...
                'value' => function ($model, $key, $index, $column) use ($editTitleList) {                    
                ...
                $ret.=Html::dropDownList('cat', 'null', $editTitleList , ['id'=>'edit_'.$id, 'style' => 'width:100px;']);
     	    ...
     	    [
                ...
                'value' => function ($model, $key, $index, $column) {                    
                $id = "note".$model['id'];    
                $ret ="<div id='viewBox_".$id."' class='gridcell' style='width:150px; ' onclick=\"javascript:showEditBox('".$id."');\">&nbsp;".$model['note']."</div>"; 
                $ret.="<div id='editBox_".$id."' class='editcell' style='width:175px;' ><nobr>";
                $ret.="<input  id='edit_".$id."'  style='width:150px;' value='".$model['note']."'>";
     ...
     /*	    [
            ...
            [
				...
				return "<div style='text-align:left;'><a href='#' class='btn btn-primary' style='padding-top: 0px; padding-bottom: 0px; padding-left: 2px; padding-right: 2px; background-color: White ;' onclick=\"javascript:finitOplata('".$model['id']."');\"><font size='-3' color='Green'><span class=\"glyphicon glyphicon-ok\" aria-hidden=\"true\"></span></font></a></div>";
                },
            ],		
            ...
            [
                ...
                'format' => 'raw',
                'value' => function ($model, $key, $index, $column) {
				return "<a href='#' onclick=\"javascript:rmOplata('".$model['id']."');\"><font color='Crimson'><span class=\"glyphicon glyphicon-remove-circle\" aria-hidden=\"true\"></span></font></a>";
                },
            ],		
